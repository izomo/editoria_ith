...
<head>
	...
	<script type="text/javascript">
		...
		function reporteCopiasPDF(){
		    var desde = $('#bd-desde').val();
		    var hasta = $('#bd-hasta').val();
		    var copias = $('#bd-copias').val();
		    window.open('../php/productos_copias.php?desde='+desde+'&hasta='+hasta+'&copias='+copias); 
 		}

 		function es_vacio(clic){
		  var campo1 = document.getElementById("bd-desde").value;
		  var campo2 = document.getElementById("bd-hasta").value;
		  var campo3 = $('#bd-copias').val();
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<h2> Reporte por Tipo de Copias</h2>	
			<div class="well well-small">
			<hr class="soft"/>
			<h4>Reporte por Tipo de Copias</h4>
			<div class="row-fluid">
			...
			<form name="form1">
				<p align="center">
					...
					<b style="color: #837E7E">Tipo de Copias</b><br>
			            <select type="text" id="bd-copias" name="servicio">
			                <?php 
