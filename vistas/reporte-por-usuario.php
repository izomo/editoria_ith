...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<h2> Reporte de Servicios Por Usuario</h2>	
		...
		<p align="center">
			...
			<input type="text" minlength="5" maxlength="50" value="<?php echo $Departamento ?>" id=Departamento name="Nom_Departamento" readonly="readonly" required>
				
			</input>

            <br>
			<b style="color: #837E7E">Maestro</b><br> 
			<input type="text" minlength="5" maxlength="50" value="<?php echo $Nombre ?>" id=maestro name="maestro" readonly="readonly" required>
