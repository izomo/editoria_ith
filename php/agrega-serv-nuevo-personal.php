...
//if (@$_POST['BtnGuardar']) {
	mysql_query("INSERT INTO reg_serv_copiado (departamento, maestro, num_copias, clave, fecha) VALUES ('$departamento','$_POST[maestro]','$_POST[num_copias]','$tclave','$fecha')", $conexion);
