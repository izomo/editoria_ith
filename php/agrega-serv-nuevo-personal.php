...
//if (@$_POST['BtnGuardar']) {
	$query=mysql_query("INSERT INTO reg_serv_copiado(id_reg_serv_copiado, departamento, maestro, num_copias, clave, fecha) VALUES ('$id_servicio','$departamento','$maestro','$num_copias','$tclave','$fecha')", $conexion);
	if($query){
